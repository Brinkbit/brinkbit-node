...
const getreset = require( './fixtures/getreset' );
...
describe( 'sdk', function() {
    describe( 'middleware', function() {
        before( function( done ) {
            this.app = express();
            this.brinkbit = new Brinkbit( env.server.config );
        ...
        it( 'should accept a config and return an express middleware function', function() {
